...
<div class="br-pagetitle">
  ...
  <div class="br-pagebody">
    <div class="br-section-wrapper">
        <h6 class="br-section-label">Update Product Details</h6>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label>Product Quantity [Ex:5] </label>
                              <input type="text" name="quantity" class="form-control" required="required" autocomplete="off" placeholder="Enter Product Quantity" value="{{$product->quantity }}">
                        </div>
                     ...
                     <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input type="submit" name="updateProduct" value="Value changes" class="btn btn-teal btn-block mg-b-10">
                            </div>
                        </div>
