    ...
    <script src="{{ asset('backend/ib/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
    ...
    <script src="{{ asset('backend/ib/rickshaw/vendor/d3.min.js') }}"></script>
    ...
    <!-- copy from the toastr JQuery lib -->
    <script type="text/javascript">
     toastr.options = {
        "closeButton": true,
        "debug": false,
